// src/pages/new-prescription-form/components/SignatureCapture.jsx
      ...
      <div className="space-y-4">
        {!signature && !isCapturing && (
          <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">Firma requerida para validar la receta médica</p>
            <Button onClick={handleStartCapture} iconName="Edit" iconPosition="left">
              Firmar Receta
            </Button>
          </div>
        )}
          ...
          <div className="border border-border rounded-lg p-4">
            <div className="w-full h-32 bg-background border border-border rounded-lg mb-4 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Área de firma (simulada)</p>
              </div>
            </div>

            <div className="flex items-center space-x-3">
              <Button onClick={handleSaveSignature} iconName="Check" iconPosition="left" size="sm">
                Guardar Firma
              </Button>
              <Button variant="outline" onClick={handleClearSignature} iconName="X" iconPosition="left" size="sm">
                Cancelar
              </Button>
            </div>
          </div>
        ...
        {signature && !isCapturing && (
          <div className="border border-success rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <Button variant="outline" size="sm" onClick={handleClearSignature} iconName="RotateCcw" iconPosition="left">
                Firmar Nuevamente
              </Button>
            </div>
            ...
            <div className="mt-3 text-xs text-muted-foreground">
              ...
              <p>Estado: {signature.verified ? "Verificado" : "No verificado"}</p>
            </div>
          </div>
        )}
        ...
        <div className="bg-info/5 border border-info/20 rounded-lg p-3">
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm">
              <p className="font-medium text-info mb-1">Firma Digital (modo demo)</p>
              <p className="text-info/80 text-xs">
                Aquí la firma es mock. El salto real es: hash + certificado + auditoría (más adelante).
              </p>
            </div>
          </div>
        </div>
