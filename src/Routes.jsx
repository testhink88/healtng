...
// 👇 NUEVO: Perfil de Tienda Pública del Vendor
...
// 👇 Mi catálogo B2B (Gestión interna)
      ...
      <ErrorBoundary>
        ...
        <Suspense fallback={<Fallback />}>
          <RouterRoutes>
            ...
            {/* ✅ RUTA CORREGIDA: Apunta a la Vitrina Pública */}
            ...
            <Route path="/analytics/appointments" element={<Navigate to="/medical-indicators" replace />} />
            <Route path="/analytics/patients" element={<Navigate to="/medical-indicators" replace />} />
            ...
            >
              ...
              {/* Marketplace B2B (Dashboard Interno) */}
              <Route path="b2b" element={<ProviderB2B />} />
              {/* Gestión de Catálogo Interno */}
            ...
            <Route path="/provider-profile-setup" element={<Navigate to="/provider/profile-setup" replace />} />

            {/* Compatibilidad (redirecciones provider) */}
            ...
            />
            <Route path="/clinic-appointments-management" element={<Navigate to="/clinic/appointments" replace />} />
            <Route
            ...
            />
            <Route path="/clinic/purchases" element={<Navigate to="/clinic/purchase-orders" replace />} />
            <Route
            ...
            />
            <Route path="/clinic-marketplace-hub" element={<Navigate to="/clinic/marketplace" replace />} />
            <Route
              path="/clinic/spaces"
              element={
                <RoleGuard allowed={["clinic", "clinic_admin"]}>
