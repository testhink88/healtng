...
// Corregido el import para apuntar a la ubicación correcta

// Lógica para los módulos de negocio
  ...
  useEffect(() => {
    ...
    if ((p.businessType || "mixto") === "producto") {
      ...
      setStats((s) => ({
        ...
        monthlyRevenue: Math.round(a.salesToday * 30), // aproximaciÃ³n
        salesToday: a.salesToday,
      }));

      // Establecer los "badges"
      setBadges({
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">
              Â¡Bienvenido a tu Panel de Proveedor!
            </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <KPICard title="Ã“rdenes Completadas" value={stats.completedOrders} icon="CheckCircle" change={15.2} trend="up" />
      </div>

      {/* MÃ³dulos */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-foreground mb-4">MÃ³dulos de Negocio Activos</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mods.inventario && (
            <ModuleCard
              ...
              badge={badges.lowStock > 0 ? `${badges.lowStock} alertas` : null}
            />
          )}
          {mods.agenda && (
            <ModuleCard
              ...
              desc="Gestiona citas, servicios y programaciÃ³n"
          ...
          <ModuleCard
            cardKey="orders-card"
            icon="ShoppingCart"
            title="Pedidos y Ã“rdenes"
            desc="Administra pedidos de productos y Ã³rdenes de servicios"
            onClick={() => navigate("/provider/orders")}
            badge={badges.pendingShipments > 0 ? `${badges.pendingShipments} pendientes` : null}
          />
          {mods.despacho && (
            <ModuleCard
              ...
              desc="Controla envÃ­os, entregas y logÃ­stica"
          ...
          {mods.rxIntake && (
            <ModuleCard
              ...
              icon="FileText"
              title="RX Intake"
              desc="Procesamiento de recetas y Ã³rdenes mÃ©dicas"
          ...
          {mods.authorizations && (
            <ModuleCard
              ...
              desc="GestiÃ³n de autorizaciones y seguros"
          ...
          <ModuleCard
            ...
            icon="BarChart3"
            title="AnalÃ­ticas"
            desc="Reportes y mÃ©tricas de rendimiento del negocio"
