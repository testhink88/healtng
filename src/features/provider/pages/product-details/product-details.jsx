...
import { getProducts } from "@/utils/components/ProductInfoForm";
...
export default function ProviderProductDetails() {
  ...
  const tabs = useMemo(
    () => [
      ...
      { id: "suppliers", label: "InformaciÃ³n de Proveedores", icon: "Building" },
    ],
    []
  );
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
              ...
              <span className="inline-flex items-center gap-1">
                <Icon name="Barcode" size={12} /> {product?.barcode || "â€”"}
              </span>
              <span className="inline-flex items-center gap-1">
