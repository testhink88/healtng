  ...
  const businessTypes = [
    {
      id: 'producto',
      name: 'Producto-Based',
      description: 'Farmacias, DroguerÃ­as, Distribuidores, Tiendas de Equipos MÃ©dicos',
      icon: 'Package',
      modules: ['inventario', 'pedidos', 'despacho', 'facturacion', 'marketplace', 'analiticas'],
      color: 'bg-blue-50 border-blue-200',
      examples: ['Farmacia', 'DroguerÃ­a', 'Distribuidor', 'Tienda de Equipos MÃ©dicos']
    },
    {
      id: 'servicio',
      name: 'Service-Based',
      description: 'ClÃ­nicas, Laboratorios, ImagenologÃ­a, EstÃ©tica MÃ©dica, VacunaciÃ³n',
      icon: 'Stethoscope',
      modules: ['agenda', 'pedidos', 'rx_intake', 'autorizaciones', 'analiticas'],
      color: 'bg-green-50 border-green-200',
      examples: ['ClÃ­nica', 'Laboratorio', 'ImagenologÃ­a', 'EstÃ©tica MÃ©dica', 'Telemedicina', 'Salud Ocupacional']
    },
    {
      id: 'mixto',
      name: 'Mixed Business',
      description: 'Ã“pticas, Centros de RehabilitaciÃ³n Integral, ClÃ­nicas con farmacia interna',
      icon: 'Building',
      modules: ['inventario', 'agenda', 'pedidos', 'despacho', 'facturacion', 'rx_intake', 'autorizaciones', 'marketplace', 'analiticas'],
      color: 'bg-purple-50 border-purple-200',
      examples: ['Ã“ptica', 'Centro de RehabilitaciÃ³n Integral', 'ClÃ­nica con farmacia interna']
    }
  ];
