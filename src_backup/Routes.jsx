...
import ProviderLayout from "@/features/provider/pages/ProviderLayout";
...
import ProviderAnalytics from "@/features/provider/pages/ProviderAnalytics";
import ProviderB2B from "@/features/provider/pages/ProviderB2B";
import ProviderRxIntake from "@/features/provider/pages/ProviderRxIntake";
import ProviderAuthorizations from "@/features/provider/pages/ProviderAuthorizations";
import ProviderDispatchManagement from "@/features/provider/pages/ProviderDispatchManagement";
import ProviderBillingManagement from "@/features/provider/pages/ProviderBillingManagement";
import ProviderModuleConfiguration from "@/features/provider/pages/ProviderModuleConfiguration";
import ProviderProfileSetup from "@/features/provider/pages/ProviderProfileSetup";
