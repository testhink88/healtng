...
import { setProviderProfile } from "../../../utils/providerProfile";
...
export default function ProviderProfileSetup() {
  ...
  const onSave = () => {
    const profile = {
      businessType,
      businessModules: modulesFor(businessType), // 👈 esto asegura que se guarden bien
      createdAt: new Date().toISOString(),
    };

    setProviderProfile(profile);  // ✅ guarda limpio
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="bg-card border border-border rounded-lg p-6 w-full max-w-md">
        <h1 className="text-xl font-bold mb-4 text-foreground">Configuración inicial de Proveedor</h1>
